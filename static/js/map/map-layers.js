...
(function (root) {
  ...
  const LAYER_DEFINITIONS = [
    ...
    },
    {
      ...
      renderOrder: 25,
      parent: 'natural_geography',
      description: 'Rajgir Hills, Mandar Hill, Brahmayoni, and Someshwar range',
    },
    ...
    },
    {
      ...
      renderOrder: 31,
      parent: 'boundaries',
      description: 'State border of Bihar',
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      description: 'Transit networks, highways, expressways and rail routes',
    },
    {
      id: 'highways',
      label: 'Highways',
      ...
      description: 'NH-31, NH-19, Purvanchal Expressway & National Highway arteries',
    ...
    },
    {
      ...
      renderOrder: 62,
      parent: 'roads_transport',
      description: 'State highways and inter-district major roads',
    ...
    },
    {
      ...
      renderOrder: 63,
      parent: 'roads_transport',
      description: 'Rural village pathways and local city streets',
    ...
    },
    {
      ...
      renderOrder: 64,
      parent: 'roads_transport',
      description: 'East Central Railway lines, express junctions, and rail stations',
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      description: 'Real-time GPS positioning, turn-by-turn routing & distance tools',
    },
    {
      id: 'my_location',
      label: 'My Location',
      ...
      renderOrder: 71,
      parent: 'routes',
      description: 'Live traveler GPS location marker and accuracy radius',
    },
    {
      id: 'active_routes',
      label: 'Routes',
      ...
      renderOrder: 72,
      parent: 'routes',
      description: 'Active travel itinerary path and driving directions polyline',
    ...
    },
    {
      ...
      renderOrder: 73,
      parent: 'routes',
      description: 'Point-to-point geodesic distance and travel duration estimation',
    },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      description: 'Tourism density intensity heatmaps and cluster analytics',
    },
    {
      id: 'heatmap',
      label: 'Heatmap',
      ...
      renderOrder: 81,
      parent: 'analytics',
      description: 'Tourist footfall and popularity intensity heatmap',
    },
    {
      id: 'density',
      label: 'Density',
      ...
      renderOrder: 82,
      parent: 'analytics',
      description: 'District-wise tourist attraction cluster density grid',
    },
  ];
